...
<head>
    ...
    <title>WEB DIANNNNNNNNNNNNNNN</title>

    <!-- Bootstrap core CSS -->
    <link href="css/bootstrap.min.css" rel="stylesheet">
	<style type="text/css">
	body {
    img-src:url(smk9putih.png);
	padding-top: 40px;
	padding-bottom: 40px;
	background-color: blue;
	background-image:url(milkyway.png);
	}
  ...
  <body>
	...
	?>
      <form class="form-signin" method="post" action="" role="form">
        ...
        <h2 class="form-signin-heading"><?php echo"<img src='smk9putih.png' widht='100' height='180' align='center'/>";?><br>
		<strong>APLIKASI<br>
		 PEMBAYARAN SPP<br>
		 SMK NEGERI 9 SEMARANG</strong></h2>
        <input type="text" name="username" class="form-control" placeholder="Username" required autofocus>
        <input type="password" name="password" class="form-control" placeholder="Password" required>
        <button class="btn btn-lg btn-primary btn-block" type="submit" name="submit">Login</button>
        <p>&nbsp;</p>
		<h5><b><center> copyright : @dianikasari </center></b></h5>
      </form>
	<?php
	}
	?>
